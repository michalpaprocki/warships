...
// And connect to the path in "lib/warships_web/endpoint.ex". We pass the
...
//
// In your "lib/warships_web/router.ex":
//
//     pipeline :browser do
//       ...
//       plug MyAuth
...
// inside a script tag in "lib/warships_web/templates/layout/app.html.heex":
//
//     <script>window.userToken = "<%= assigns[:user_token] %>";</script>
//
// You will need to verify the user token in the "connect/3" function
// in "lib/warships_web/channels/user_socket.ex":
//
...
if (userToken) {
  ...
  //     if (e.key === "Enter") {
  //       lobbyChannel.push("new_msg", { body: lobbyChatInput.value });
